...
cookie='koa:sess=eyJ1c2VySWQiOjQxNzE3NiwiX2V4cGlyZSI6MTc5NDk4MzI4Mjk3NSwiX21heEFnZSI6MjU5MjAwMDAwMDB9; koa:sess.sig=uTVsTm5ovFUICswWr0jzh-fxUpY'
...
echo '-----------------status-----------------'
time=$(curl -H "cookie:$cookie" -H "referer:$referer" -H "origin:$origin" -H "user-agent:$useragent" -X GET 'https://glados.cloud/api/user/status' | grep -Eo '"leftDays":"[^"]*"')
echo $time
